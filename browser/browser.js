...
onload = function() {
  ...
  webview.windowContainer = document.getElementById('testcontainer');
...
function doLayout() {
  ...
  webview.style.width = '640px';//webviewWidth + 'px';
  webview.style.height = '480px'; //webviewHeight + 'px';
...
function handleNewWindow(event) {
  console.log(event);
  event.window.style.width = '400px';
  event.window.style.height = '400px';
  // Allow new windows.
  event.window.setAttribute('allow', 'open');
}
